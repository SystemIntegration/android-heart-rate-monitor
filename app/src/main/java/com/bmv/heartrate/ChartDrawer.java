...
class ChartDrawer
{
    ...
    ChartDrawer(Context context, TextureView chartTextureView) {
        this.chartTextureView = chartTextureView;


        paint.setStyle(Paint.Style.STROKE);

        paint.setColor(context.getResources().getColor(R.color.main_color_4));
        paint.setAntiAlias(true);
        paint.setStrokeWidth(2);

        fillWhite.setStyle(Paint.Style.FILL);
        fillWhite.setColor(context.getResources().getColor(R.color.main_color_3));
